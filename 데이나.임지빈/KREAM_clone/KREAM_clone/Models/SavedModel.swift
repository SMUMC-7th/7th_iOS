...
final class dummySavedModel { // final = 데이터 클래스 수정 하지 못하도록
    public static let savedDatas: [SavedModel] = [ //static = 싱글톤으로 더미 데이터를 사용할 수 있도록
        ...
        SavedModel(savedImage: "SavedItem2",savedName: "골드 반지",savedDescription: "결혼 준비하는 당신?! 약혼녀에게 이 반지를 선물하는 건 어때요?", savedPrice: "12,000원", savedBookmark: "Bookmark"),
        SavedModel(savedImage: "SavedItem3",savedName: "하얀 신발", savedDescription: "짝퉁 나이키 신발!", savedPrice: "90,000원", savedBookmark: "Bookmark"),
        ...
        SavedModel(savedImage: "SavedItem6",savedName: "황제 잠옷", savedDescription: "어느 나라의 황제가 입었다던 잠옷 크리스마스 트리같아 보이는 디자인!", savedPrice: "120,000,000원", savedBookmark: "Bookmark"),
        SavedModel(savedImage: "SavedItem7",savedName: "고장난 기타", savedDescription: "블라블라블라블라 블라브라브랍르ㅏ", savedPrice: "120,000원", savedBookmark: "Bookmark"),
        SavedModel(savedImage: "SavedItem8",savedName: "하얀 음료", savedDescription: "이 음료를 마시면 건강해져요 근데 어디가 건강해질까요? 한번 마시겠..", savedPrice: "999,999,000원", savedBookmark: "Bookmark"),
